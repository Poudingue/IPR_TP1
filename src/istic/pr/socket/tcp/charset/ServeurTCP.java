...
public class ServeurTCP {
	...
	public static void traiterSocketCliente(Socket socketVersUnClient) {
		try {
			BufferedReader liseur = creerReader(socketVersUnClient,"utf-8");
			PrintWriter ecriveur = creerPrinter(socketVersUnClient,"utf-8");
			while (true) {
	...
	public static BufferedReader creerReader(Socket socketDepuisUnClient, String charset) throws IOException {
		return new BufferedReader(new InputStreamReader(socketDepuisUnClient.getInputStream(), charset));
	}
